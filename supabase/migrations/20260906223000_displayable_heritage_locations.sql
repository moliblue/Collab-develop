-- Shared read model for Discover, Map, and Plan. Source rows remain intact;
-- incomplete locations are simply not exposed to app modules.
create or replace view public.displayable_heritage_locations
...
comment on view public.displayable_heritage_locations is
  'Google-matched active heritage locations with a currently displayable cover image.';
